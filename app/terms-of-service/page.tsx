...
export default async function HomePage() {
  return (
    ...
    <ul className="max-sm:text-sm">
        <li>
        <p className=" px-12 mx-auto lg:w-1/2 mb-6">1: Clients shall not place orders for items that cannot be sold within their jurisdiction, as listed within the product description of the specified item. </p>
        </li>
        <li>
