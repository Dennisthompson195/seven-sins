...
const Productline = () => {
  return (
    <div className="mb-40 lg:mt-0 xs:max-lg:mt-2 mx-auto w-screen items-center justify-center">
      <h1 className='text-center text-black font-medium relative text-base'>OUR PRODUCTS</h1>
    <hr className=' bg-black relative top-9 text-black mx-auto justify-center items-center text-center border-neutral-400 rounded-3xl opacity-80 w-8 -mt-8 border-y-2  font-extrabold'/>
          <section className=' h-full  p-6 max-sm:-mt-4 font-semibold 
           grid max-w-screen gap-x-0 gap-y-8  mx-auto items-center text-center justify-center mt-6 mb-12 md:grid-cols-4 max-sm:grid-rows-3 md:grid-rows-2 :grid-cols-2 xs:max-md:grid-cols-2  lg:w-2/3'>
          <div className='block relative lg:h-56 lg:w-56 xs:w-40 xs:h-40 xl:border xl:border-solid xl:border-neutral-200 xl:hover:border-neutral-300 xs:max-xl:border-none 
           ...
           /></Link><h2 className="relative">Naval Orange</h2></div>
             ...
             place-content-center justify-center text-center'><Link href="/product/pant"><Image
             src='/Pear 1.png'
             width={200}
             height={200}
             alt='logo'
...
<div className='block relative lg:h-56 lg:w-56 mx-auto mt-0 xs:-mt-8 xs:w-40 xs:h-40 xl:border xl:border-solid xl:border-neutral-200 xl:hover:border-neutral-300 xs:max-xl:border-none
               place-content-center justify-center text-center'><Link href="/shop"><Image
             src='/Pineapple 4.png'
             width={200}
             height={200}
             alt='logo'
